...
import { generateAnimationArray } from "@/lib/generateAnimationArray";
import { sortingAlgorithmsData } from "@/lib/sortingAlgorithmsData";
          ...
          <div className="h-[66px] relative flex items-center justify-between w-full">
            ...
            <div className="flex items-center justify-center gap-4">
              <Slider
                ...
                value={sortingSpeed}
                handleChange={(e) => setSortingSpeed(Number(e.target.value))}
              />
